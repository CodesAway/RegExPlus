 ...
 * <a href=
 * "http://en.wikipedia.org/wiki/Longest_common_subsequence_problem">http
 ...
 * @see <a href=
 *      "http://en.wikibooks.org/wiki/Algorithm_implementation/Strings/Longest_common_subsequence#Java">Source</a>
 */
public abstract class LongestCommonSubsequence<E> {
	/**
	 * The LCS table.
	 *
	 * The <i>i</i>th row and <i>j</i>th column shows the length of the LCS between
	 ...
	 *
	 * @param i the 1-based index of the element in <i>X</i>
	 * @param j the 1-based index of the element in <i>Y</i>
	 * @return <code>true</code> if the two specified elements are equal;
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * Returns the length of the longest common subsequence between X<sub>1..i</sub>
	 * and Y<sub>1..j</sub>.
	 *
	 * @param i 1-based position in the "before" value
	 * @param j 1-based position in the "after" value
	 * @return the length of the longest common subsequence between X<sub>1..i</sub>
	 *         and Y<sub>1..j</sub>
	 */
	 ...
	 * distance</a> when only insertion and deletion is allowed (no substitution).
	 *
